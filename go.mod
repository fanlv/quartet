module github.com/fanlv/quartet

go 1.25.0

require (
	github.com/bytedance/sonic v1.15.0
	github.com/cloudwego/eino v0.9.0-alpha.5.0.20260429112230-58d7b8d255d8
...
// replace github.com/eino-contrib/acp => /data00/home/fanlv/acp

// Local development against an un-published sandbox version: use go.work
// (not committed) to add a replace for github.com/deep-agent/sandbox pointing
// at a local checkout. Do NOT add an absolute-path `replace` directive here —
// it breaks reproducible builds for other developers and CI.
