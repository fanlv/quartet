...
// DeepCopy must independently copy the GroupActualIterations map so the live
// job and a saved snapshot don't share it — otherwise a concurrent backfill
// mutation races json.Marshal of the snapshot. Regression test.
